...
//                $.post("http://localhost/lunwen/index.php/Home/ManagerMoney/money_money",{
//                              "dept_id":data
//                         },function(data){
//                            $("#money_num").html(data);
...
<div style="margin-top: 10px;margin-bottom: 30px;">
    <form action="http://localhost/lunwen/index.php/Home/ManagerMoney/money_money" method="post">
        <label>设备所属部门:</label>
...
<div>
    ...
    的固定资产价值是：<span id="money_num" style="color: red;">
            <?php if($money == null): ?>0
                <?php else: ?>
                <?php echo ($money); endif; ?>
</span>元
